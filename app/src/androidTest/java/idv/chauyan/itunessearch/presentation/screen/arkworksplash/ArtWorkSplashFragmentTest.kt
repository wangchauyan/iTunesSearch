...
import idv.chauyan.itunessearch.presentation.screen.artworksplash.view.ArtWorkSplashFragment
import org.junit.Test
import org.junit.runner.RunWith

@RunWith(AndroidJUnit4::class)
@MediumTest
class ArtWorkSplashFragmentTest {
  ...
  fun checkSplashLogo() {
    ...
    val scenario = launchFragmentInContainer<ArtWorkSplashFragment>()
    scenario.onFragment {
