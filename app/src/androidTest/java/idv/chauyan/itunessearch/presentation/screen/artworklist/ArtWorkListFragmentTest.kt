...
import idv.chauyan.itunessearch.presentation.screen.artworklist.view.MockArtWorkListFragment
...
class ArtWorkListFragmentTest {
  ...
  fun shouldShowArtWorkListView() {
    ...
    val scenario = launchFragmentInContainer<MockArtWorkListFragment>()
    scenario.onFragment {
