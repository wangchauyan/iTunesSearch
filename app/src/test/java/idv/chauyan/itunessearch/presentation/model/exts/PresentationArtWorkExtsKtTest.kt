...
class PresentationArtWorkExtsKtTest {
  ...
  fun toDataModel() {
    ...
    assertThat(destPresentationArtWork?.collectionType).isEqualTo(srcDomainArtWork?.collectionType)
    ...
    assertThat(destPresentationArtWork?.amgArtistId).isEqualTo(srcDomainArtWork?.amgArtistId)
    ...
    assertThat(destPresentationArtWork?.collectionViewUrl).isEqualTo(srcDomainArtWork?.collectionViewUrl)
    assertThat(destPresentationArtWork?.collectionPrice).isEqualTo(srcDomainArtWork?.collectionPrice)
    assertThat(destPresentationArtWork?.trackCount).isEqualTo(srcDomainArtWork?.trackCount)
    assertThat(destPresentationArtWork?.copyright).isEqualTo(srcDomainArtWork?.copyright)
    ...
    assertThat(destPresentationArtWork?.primaryGenreName).isEqualTo(srcDomainArtWork?.primaryGenreName)
  ...
  fun toDomainModel() {
    ...
    assertThat(destDomainArtWork?.collectionType).isEqualTo(srcPresentationArtWork?.collectionType)
    ...
    assertThat(destDomainArtWork?.amgArtistId).isEqualTo(srcPresentationArtWork?.amgArtistId)
    ...
    assertThat(destDomainArtWork?.collectionViewUrl).isEqualTo(srcPresentationArtWork?.collectionViewUrl)
    assertThat(destDomainArtWork?.collectionPrice).isEqualTo(srcPresentationArtWork?.collectionPrice)
    assertThat(destDomainArtWork?.trackCount).isEqualTo(srcPresentationArtWork?.trackCount)
    assertThat(destDomainArtWork?.copyright).isEqualTo(srcPresentationArtWork?.copyright)
    ...
    assertThat(destDomainArtWork?.primaryGenreName).isEqualTo(srcPresentationArtWork?.primaryGenreName)
